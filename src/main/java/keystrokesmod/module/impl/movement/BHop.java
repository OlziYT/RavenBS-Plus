...
public class BHop extends Module {
    ...
    private String[] infoModes = new String[] {"raven bS", "raven b4"};
    private int Strafies;
    public String[] modes = new String[] {"Strafe", "Ground", "Glide", "7 tick", "7 tick strafe", "8 tick", "8 tick strafe", "9 tick", "9 tick strafe"};
    ...
    public String getInfo() {
        ...
        if (infoMode.getInput() == 1) {
            switch (modeIndex) {
                case 3: // 7 tick
                case 5: // 8 tick
                case 7: // 9 tick
                    return "Low";
                case 4: // 7 tick strafe
                case 6: // 8 tick strafe
                case 8: // 9 tick strafe
                    return "Semi";
                default:
    ...
    public void onPreMotion(PreMotionEvent e) {
        ...
        if (mode.getInput() >= 1) { // Ground mode
        ...
        switch ((int) mode.getInput()) {
            ...
            case 5: // 8 tick mode
                ...
                break;
            case 6: // 8 tick strafe mode
                if (mode.getInput() == 6 && didMove) {
                    int simpleY = (int) Math.round((e.posY % 1) * 10000);
            ...
            case 7: // 9 tick mode
                ...
                break;
            case 8: // 9 tick strafe mode
                if (mode.getInput() == 8 && didMove) {
                    int simpleY = (int) Math.round((e.posY % 1) * 10000);
    ...
    public void onPreUpdate(PreUpdateEvent e) {
        if (canstrafe()) {
            ...
            if (Strafies >= 2 && (!blockRelativeToPlayer(0, mc.thePlayer.motionY * 3, 0).getUnlocalizedName().contains("air") || Strafies == 9) && !ModuleManager.scaffold.isEnabled()) {
                if (currentMode == 2 || currentMode == 4 || currentMode == 6 || currentMode == 8) { // Glide, 7 tick strafe, 8 tick strafe, 9 tick strafe
